...
import com.example.travelapp.databinding.ActivityLakesBinding
...
class LakesActivity : AppCompatActivity() {
    lateinit var binding: ActivityLakesBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityLakesBinding.inflate(layoutInflater)
    ...
    private fun initview() {
        ...
        binding.btnselectimag.setOnClickListener {
            ...
            binding.BtnAdd.setOnClickListener {
                ...
                var key = reference.root.child("LakesTb").push().key ?: ""
                ...
                reference.root.child("LakesTb").child(key).setValue(modelClass)
